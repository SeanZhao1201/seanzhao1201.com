...
**2026-07-18** · 线上 = main `fb543fb` · 大版本翻新已上线：移动端下拉菜单、reduced-motion 支持、自托管字体、构建期 markdown、favicon + OG 分享卡 + JSON-LD + sitemap/robots、字体加载后 ScrollTrigger refresh。Web Analytics 确认在收数：加载 648ms，LCP 100% Good，INP Good，CLS 有少量 Poor 待观察。
